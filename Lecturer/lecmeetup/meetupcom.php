...
function btn(){
  ...
  $nextTarget = $_POST['target'];
    ...
    if($databaseconnection == null){
        ...
        if($btn == "1"){
            $sql = "UPDATE request SET meetdate = '$date',comment = '$comment',mstate = '1' WHERE R_ID = '$R_ID'";
        }
        elseif($btn == "0"){
            $sql = "UPDATE request SET meetdate = '$date',nextTarget = '$nextTarget',mstate = '1' WHERE R_ID = '$R_ID'";
        }
        elseif($btn == "2"){
           
            $sql = "UPDATE request SET R_date = '$date',comment = '$comment',nextTarget = '$nextTarget',mstate = '1' WHERE R_ID = '$R_ID'";
        }
        else{
